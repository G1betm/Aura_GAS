	...
	const TMap<FGameplayTag, FGameplayEffectAttributeCaptureDefinition> InTagsToDefs) const
{
	...
	for (TTuple<FGameplayTag, FGameplayTag> Pair : GameplayTags.DamageTypesToDebuffs)
	{
		...
		{
			// Determine of there was a successful debuff
                                              ...
                                              FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	for (const TPair<FGameplayTag, FGameplayTag>& Pair : FAuraGameplayTags::Get().DamageTypesToResistances)
	{
		...
		checkf(TagsToCaptureDefs.Contains(ResistanceTag), TEXT("TagsToCaptureDef doesn't contains Tag [%s] in ExecCalc_Damage"), *ResistanceTag.ToString())
	...
	// CriticalHitResistance reduces CriticalHiyChance by a certain percentage
