...
void UAuraAbilitySystemLibrary::SetIsRadialDamageEffectParam(FDamageEffectParams& DamageEffectParams, bool InIsRadial, float InnerRadius, float OuterRadius, FVector Origin)
{
