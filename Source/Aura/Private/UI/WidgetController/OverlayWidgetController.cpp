...
{
	//TODO Get information abput all given abilities, look up their AbilityInfo and broadcast it to widgets
...
void UOverlayWidgetController::OnXPChanged(int32 NewXP) const
{
	...
	if (Level <= MaxLevel && Level > 0)
	{
		...
		const float XPBarPercent = static_cast<float>(XPForThisLevel) / static_cast<float>(LevelUpRequirement);
